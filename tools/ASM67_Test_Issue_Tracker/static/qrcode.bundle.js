/* QRCode for JavaScript, Copyright (c) 2009 Kazuhiko Arase, MIT License. Bundled locally for ASM67 tracker. */
(function(global){
var modules={},cache={};
function define(id,fn){modules[id]=fn;}
function req(id){if(cache[id])return cache[id].exports;if(!modules[id])throw new Error("QR module not found: "+id);var m={exports:{}};cache[id]=m;modules[id](m,m.exports,req);return m.exports;}
...
global.ASM67QRCode={QRCode:req('./index'), QRErrorCorrectLevel:req('./QRErrorCorrectLevel')};
})(window);
