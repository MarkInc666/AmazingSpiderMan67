...
"""
Executioner of Paris Robot placeholder villain mode.

Mode idea:
A countdown threatens jackpot value; hit rescue shots to delay and cash.
...
class ExecutionerOfParisRobot(Mode):
    MODE_KEY = "executioner_of_paris_robot"
    DISPLAY_NAME = "Executioner of Paris Robot"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
