...
"""
Doctor Manta placeholder villain mode.

Mode idea:
Manta traps ball in saucers; escape by hitting lit rescue shots and then cash at VUK/saucer.
...
class DoctorManta(Mode):
    MODE_KEY = "doctor_manta"
    DISPLAY_NAME = "Doctor Manta"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
