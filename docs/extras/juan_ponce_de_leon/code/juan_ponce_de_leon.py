...
"""
Juan Ponce de León placeholder villain mode.

Mode idea:
Value drains until fountain shot is hit; fountain resets timer and raises jackpot.
...
class JuanPonceDeLeon(Mode):
    MODE_KEY = "juan_ponce_de_leon"
    DISPLAY_NAME = "Juan Ponce de León"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
