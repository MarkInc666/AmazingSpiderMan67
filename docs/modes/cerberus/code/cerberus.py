...
class Cerberus(CaseFileMixin, Mode):
    ...
    def _update_mode_status(self):
        # Once the Cerberus countdown is running, base mode owns the live
        # large red timer. Ordinary state syncs must not replace it with the
        # smaller blue status widget.
