...
"""
Fantastic Fakir placeholder villain mode.

Mode idea:
Fakir controls animals; hit rhythm shots in order to break control and light jackpot.
...
class FantasticFakir(Mode):
    MODE_KEY = "fantastic_fakir"
    DISPLAY_NAME = "Fantastic Fakir"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
