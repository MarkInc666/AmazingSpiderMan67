...
class VonRantenraven(CaseFileMixin, Mode):
    """Baron von Rantenraven: Sky Harbor.
    ...
    MODE_KEY = "von_rantenraven"
    DISPLAY_NAME = "BARON VON RANTENRAVEN"
    ...
    REPEAT_TARGET_VALUE = 250_000
    MORE_JACKPOTS_REPEAT_VALUE = 500_000
    ROOFTOP_JACKPOTS_TO_COMPLETE = 1

    TARGETS = {
        "left": {
            "switch": "s_upper_target_left_active",
            "needed": "von_rantenraven_target_left_needed",
            "solid": "von_rantenraven_target_left_solid",
            "off": "von_rantenraven_target_left_off",
        },
        "center": {
            "switch": "s_upper_target_center_active",
            "needed": "von_rantenraven_target_center_needed",
            "solid": "von_rantenraven_target_center_solid",
            "off": "von_rantenraven_target_center_off",
        },
        "right": {
            "switch": "s_upper_target_right_active",
            "needed": "von_rantenraven_target_right_needed",
            "solid": "von_rantenraven_target_right_solid",
            "off": "von_rantenraven_target_right_off",
        },
    }
    ...
    def mode_start(self, **kwargs):
        ...
        self.publish_case_file_bonus_events("von_rantenraven")
        self.publish_active_case_file_helpers([
            ("more_jackpots", "REPEAT TARGETS SCORE 500K"),
        ...
        self.machine.events.post("von_rantenraven_all_lights_off")
        self.machine.events.post("von_rantenraven_saucers_needed")
    ...
    def mode_stop(self, **kwargs):
        ...
        self.delay.remove("von_rantenraven_reenable_upper_flippers")
        self.delay.remove("von_rantenraven_reset_for_next_attempt")
        self.machine.events.post("cmd_upper_flippers_enable")
        self.machine.events.post("von_rantenraven_all_lights_off")
        self.machine.events.post("von_rantenraven_stop_all_shows")
        self.machine.events.post("rooftop_diverter_close")
    ...
    def _upper_flipper_pressed(self, **kwargs):
        ...
        self._update_mode_status()
        self.machine.events.post("von_rantenraven_flips_changed", flips=self.flips_remaining)
    ...
    def _complete_roof_attempt(self):
        ...
        self.delay.add(name="von_rantenraven_reset_for_next_attempt", ms=750, callback=self._reset_for_next_attempt)
    ...
    def _fail_roof_attempt(self):
        ...
        self.roof_attempt_active = False
        self.machine.events.post("von_rantenraven_roof_attempt_failed")
        self.machine.events.post("cmd_upper_flippers_disable")
        self._show_message("OUT OF FLIPS", "UPPER FLIPPER DISABLED", seconds="4")
        self.delay.add(name="von_rantenraven_reenable_upper_flippers", ms=self.FLIP_DISABLE_MS, callback=self._reenable_after_failed_attempt)
