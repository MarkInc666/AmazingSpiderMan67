...
class VillainBookends(Mode):
    ...
    VILLAINS = {
        ...
        "centaur": {
            "title": "CENTAUR",
            "intro_1": "Placeholder mode for the Monster Island chapter.",
            "intro_2": "Shoot lit/common shots to build progress.",
            "intro_3": "Full rules will be built later.",
            "summary_title_complete": "CENTAUR DEFEATED",
            "summary_title_failed": "CENTAUR ESCAPED",
            "stat_1_label": "HITS",
            "stat_1_var": "centaur_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "centaur_major_hits",
        ...
        "cerberus": {
            "title": "CERBERUS",
            "intro_1": "Upper targets light saucer jackpots.",
            "intro_2": "Spinner builds value. Matching saucer scores 2X.",
            "intro_3": "After first jackpot, keep resetting the timer.",
            "summary_title_complete": "CERBERUS DEFEATED",
            "summary_title_failed": "CERBERUS TIMER EXPIRED",
            "stat_1_label": "JACKPOTS",
            "stat_1_var": "cerberus_jackpots_collected",
            "stat_2_label": "BEST JACKPOT",
            "stat_2_var": "cerberus_best_jackpot",
        ...
        "cyclops": {
            ...
            "stat_1_label": "HITS",
            "stat_1_var": "cyclops_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "cyclops_major_hits",
        ...
        "reptilla": {
            ...
            "intro_2": "Shoot lit/common shots to build progress.",
            "intro_3": "Full rules will be built later.",
            "summary_title_complete": "REPTILLA DEFEATED",
            "summary_title_failed": "REPTILLA ESCAPED",
            "stat_1_label": "HITS",
            "stat_1_var": "reptilla_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "reptilla_major_hits",
        ...
        "mole_man": {
            ...
            "intro_2": "Shoot lit/common shots to build progress.",
            "intro_3": "Full rules will be built later.",
            "summary_title_complete": "MOLE MAN DEFEATED",
            "summary_title_failed": "MOLE MAN ESCAPED",
            "stat_1_label": "HITS",
            "stat_1_var": "mole_man_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "mole_man_major_hits",
        ...
        "enforcers": {
            "title": "ENFORCERS",
            "intro_1": "Placeholder mode for the Crime Wave chapter.",
            "intro_2": "Shoot lit/common shots to build progress.",
            "intro_3": "Full rules will be built later.",
            "summary_title_complete": "ENFORCERS DEFEATED",
            "summary_title_failed": "ENFORCERS ESCAPED",
            "stat_1_label": "HITS",
            "stat_1_var": "enforcers_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "enforcers_major_hits",
        ...
        "ox": {
            ...
            "intro_2": "Shoot lit/common shots to build progress.",
            "intro_3": "Full rules will be built later.",
            "summary_title_complete": "OX DEFEATED",
            "summary_title_failed": "OX ESCAPED",
            "stat_1_label": "HITS",
            "stat_1_var": "ox_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "ox_major_hits",
            "points_var": "ox_mode_points",
            "completed_var": "ox_completed",
            "song": "play_song_14",
        },
        ...
        "fifth_avenue_phantom": {
            ...
            "intro_2": "Shoot lit/common shots to build progress.",
            "intro_3": "Full rules will be built later.",
            "summary_title_complete": "FIFTH AVENUE PHANTOM DEFEATED",
            "summary_title_failed": "FIFTH AVENUE PHANTOM ESCAPED",
            "stat_1_label": "HITS",
            "stat_1_var": "fifth_avenue_phantom_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "fifth_avenue_phantom_major_hits",
        ...
        "frederick_foswell": {
            ...
            "intro_2": "Shoot lit/common shots to build progress.",
            "intro_3": "Full rules will be built later.",
            "summary_title_complete": "FREDERICK FOSWELL DEFEATED",
            "summary_title_failed": "FREDERICK FOSWELL ESCAPED",
            "stat_1_label": "HITS",
            "stat_1_var": "frederick_foswell_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "frederick_foswell_major_hits",
        ...
        "blackwell": {
            ...
            "intro_2": "Shoot lit/common shots to build progress.",
            "intro_3": "Full rules will be built later.",
            "summary_title_complete": "BLACKWELL DEFEATED",
            "summary_title_failed": "BLACKWELL ESCAPED",
            "stat_1_label": "HITS",
            "stat_1_var": "blackwell_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "blackwell_major_hits",
