...
class VillainBookends(Mode):
    ...
    VILLAINS.update({
        ...
        "monster_island_breakout": {
            "title": "MONSTER ISLAND BREAKOUT",
            "intro_1": "Chapter 3 mini-wizard multiball.",
            "intro_2": "Survive the monster breakout.",
            "intro_3": "Multiball end shows the chapter summary.",
            "summary_title_complete": "MONSTER ISLAND CLEARED",
            "summary_title_failed": "MONSTER ISLAND OVERRUN",
            "stat_1_label": "HITS",
