...
class VillainBookends(Mode):
    ...
    VILLAINS = {
        ...
        'fly_twins': {
            ...
            'stat_1_label': 'ROUNDS',
            'stat_1_var': 'fly_twins_rounds_completed',
            'stat_2_label': 'JACKPOTS',
            'stat_2_var': 'fly_twins_jackpots',
            'points_var': 'active_mode_points',
        ...
        'molemen': {
            ...
            'stat_1_var': 'molemen_biggest_jackpot',
            'stat_2_label': 'JACKPOTS',
            'stat_2_var': 'molemen_jackpots',
            'points_var': 'active_mode_points',
        ...
        'sinister_surge': {
            ...
            'intro_2': 'Clear five villain stages.',
        ...
        'trubble_unleashed': {
            ...
            'stat_1_label': 'JACKPOTS',
            'stat_1_var': 'trubble_unleashed_saucer_jackpots',
            'stat_2_label': 'STAGED HITS',
            'stat_2_var': 'trubble_unleashed_staged_successes',
            'points_var': 'active_mode_points',
