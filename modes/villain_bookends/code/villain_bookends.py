...
class VillainBookends(Mode):
    ...
    VILLAINS = {
        ...
        'infinata': {
            ...
            'stat_1_label': 'AREAS',
            'stat_1_var': 'infinata_areas_completed',
            'stat_2_label': 'SUPERS',
            'stat_2_var': 'active_mode_major_hits',
            'points_var': 'active_mode_points',
        ...
        'dr_zapp': {
            'title': 'DOCTOR ZAPP',
            'intro_1': 'Hit one target in each bank.',
            'intro_2': 'Upper targets boost Camera Flashes.',
            'intro_3': 'Reach 25 flashes on the Roof spinner.',
            'summary_title_complete': 'DOCTOR ZAPP DEFEATED',
            'summary_title_failed': 'DOCTOR ZAPP ESCAPED',
            'stat_1_label': 'CAMERA FLASHES',
            'stat_1_var': 'dr_zapp_camera_flashes',
            'stat_2_label': 'SPINNER SPINS',
            'stat_2_var': 'dr_zapp_spinner_spins',
            'points_var': 'active_mode_points',
        ...
        'plutonians': {
            ...
            'intro_1': 'All six areas are frozen.',
            'intro_2': 'Upper targets block the Freeze Ray.',
            'intro_3': 'Thaw all six areas at once.',
            'summary_title_complete': 'CONTROL REPAIRED',
            'summary_title_failed': 'CITY FROZEN',
            'stat_1_label': 'AREAS THAWED',
            'stat_1_var': 'active_mode_hits',
            'stat_2_label': 'FREEZE RAY BLOCKERS',
            'stat_2_var': 'active_mode_major_hits',
            'points_var': 'active_mode_points',
