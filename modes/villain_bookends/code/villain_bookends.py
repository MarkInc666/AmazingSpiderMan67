...
class VillainBookends(Mode):
    ...
    VILLAINS = {
        ...
        'harley_clivendon': {
            ...
            'stat_1_label': 'VUK JACKPOTS', 'stat_1_var': 'harley_vuk_jackpots', 'stat_2_label': 'HARLEY JACKPOTS', 'stat_2_var': 'harley_bonus',
        ...
        'noah_boddy': {
            ...
            'stat_1_var': 'noah_boddy_spinner_hits',
            'stat_2_label': 'INVISIBLE FORTUNE',
            'stat_2_var': 'noah_boddy_bonus',
            'points_var': 'active_mode_points',
        ...
        'igor': {
            ...
            'stat_2_var': 'igor_biggest_jackpot',
            'points_var': 'active_mode_points',
