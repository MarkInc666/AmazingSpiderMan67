...
class VillainBookends(Mode):
    ...
    VILLAINS = {
        ...
        "cerberus": {
            ...
            "stat_1_label": "HITS",
            "stat_1_var": "cerberus_hits",
            "stat_2_label": "MAJOR HITS",
            "stat_2_var": "cerberus_major_hits",
        ...
        "blackwell": {
            "title": "BLACKWELL",
            "intro_1": "Hit Blackwell's predicted shots before time runs out.",
            "intro_2": "Spinner adds time to the current shot.",
            "intro_3": "Each Jackpot collected makes the next one bigger.",
            ...
            "stat_2_var": "blackwell_best_jackpot",
