...
class VillainBookends(Mode):
    ...
    VILLAINS = {
        ...
        'bolton_boomer': {
            ...
            'intro_1': 'Hit the lit target.',
            'intro_2': 'Capture one ball.',
            'intro_3': 'Shoot the VUK Super.',
            'summary_title_complete': 'THUNDER RUMBLE ENDED',
            'summary_title_failed': 'BOLTON AND BOOMER ESCAPED',
            'stat_1_label': 'SUPER JACKPOTS',
            'stat_1_var': 'bolton_boomer_super_jackpots',
            'stat_2_label': 'BIGGEST SUPER',
            'stat_2_var': 'bolton_boomer_biggest_super',
            'points_var': 'active_mode_points',
