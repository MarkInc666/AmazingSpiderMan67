...
class VillainProgression(Mode):
    ...
    CHAPTERS = [
        ...
        },
        {
            'key': 'crime_wave',
            'name': 'Crime Wave',
            'villains': ['master_plan', 'fly_brothers', 'fifth_avenue_phantom', 'enforcers', 'doctor_cool'],
        ...
        },
        {
            'key': 'danger_lurks',
            'name': 'Danger Lurks',
            'villains': ['harley_clivendon', 'conquistador', 'spider_slayer', 'metal_eating_monster', 'fiddler'],
        ...
        },
        {
            ...
            'villains': ['clive_blotto', 'dr_zap', 'voltan_boomer', 'snowman', 'plutonians'],
        ...
        },
        {
            ...
            'villains': ['charles_cameo', 'brutus', 'desperado', 'skymaster', 'swamp_reptiles'],
    ...
    VILLAINS = {
        ...
        'master_plan': {'chapter': 4, 'name': 'The Plotter', 'start_event': 'start_mode_master_plan'},
        'fly_brothers': {'chapter': 4, 'name': 'Fly Brothers', 'start_event': 'start_mode_fly_brothers'},
        'fifth_avenue_phantom': {'chapter': 4, 'name': '5th Avenue Phantom', 'start_event': 'start_mode_fifth_avenue_phantom'},
        ...
        'metal_eating_monster': {'chapter': 5, 'name': 'Metal-Eating Monster', 'start_event': 'start_mode_metal_eating_monster'},
        ...
        'scarlet_sorcerer': {'chapter': 6, 'name': 'Kotep - The Scarlet Sorcerer', 'start_event': 'start_mode_scarlet_sorcerer'},
        ...
        'professor_pretoris': {'chapter': 7, 'name': 'Professor Pretoris', 'start_event': 'start_mode_professor_pretoris'},
        ...
        'dr_zap': {'chapter': 8, 'name': 'Doctor Zapp', 'start_event': 'start_mode_dr_zap'},
        'voltan_boomer': {'chapter': 8, 'name': 'Voltan and Boomer', 'start_event': 'start_mode_voltan_boomer'},
        ...
        'molemen': {'chapter': 9, 'name': 'Molemen', 'start_event': 'start_mode_molemen'},
        ...
        'swamp_reptiles': {'chapter': 10, 'name': 'Swamp Reptiles', 'start_event': 'start_mode_swamp_reptiles'},
    ...
    COMPLETION_EVENTS = {
        ...
        'master_plan_mode_complete': ('master_plan', True),
        'fly_brothers_mode_complete': ('fly_brothers', True),
        ...
        'voltan_boomer_mode_complete': ('voltan_boomer', True),
