...
class VillainProgression(Mode):
    ...
    VILLAINS = {
        ...
        'lizard': {'chapter': 1, 'name': 'Green Lizard', 'start_event': 'start_mode_lizard'},
        ...
        'metal_eating_monster': {'chapter': 5, 'name': 'Metal Monster', 'start_event': 'start_mode_metal_eating_monster'},
        ...
        'scarlet_sorcerer': {'chapter': 6, 'name': 'Kotep', 'start_event': 'start_mode_scarlet_sorcerer'},
