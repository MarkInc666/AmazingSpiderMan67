...
"""
Henry Smythe placeholder villain mode.

Mode idea:
Smythe repairs disabled robot systems unless repair shots are stopped.
...
class HenrySmythe(Mode):
    MODE_KEY = "henry_smythe"
    DISPLAY_NAME = "Henry Smythe"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
