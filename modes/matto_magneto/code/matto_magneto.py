...
"""
Matto Magneto placeholder villain mode.

Mode idea:
Magnet beam pulls lit shot around playfield; spinner stabilizes beam for a jackpot.
...
class MattoMagneto(Mode):
    MODE_KEY = "matto_magneto"
    DISPLAY_NAME = "Matto Magneto"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
