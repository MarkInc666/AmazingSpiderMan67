...
"""
PhantomFromDepthsOfTime placeholder villain mode.

Mode idea:
One target lights for a short quickdraw; hit it to build showdown jackpot.
...
class PhantomFromDepthsOfTime(Mode):
    MODE_KEY = "phantom_from_depths_of_time"
    DISPLAY_NAME = "Phantom from the Depths of Time"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
