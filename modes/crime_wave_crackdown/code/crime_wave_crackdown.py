...
"""
Crime Wave Crackdown placeholder mini-wizard.

Mode idea:
Collect leads, reveal criminals, survive trick shots, and finish timed predictions during a citywide crime wave.
"""


class CrimeWaveCrackdown(Mode):
    MODE_KEY = "crime_wave_crackdown"
    DISPLAY_NAME = "Crime Wave Crackdown"
    HIT_SCORE = 50_000
