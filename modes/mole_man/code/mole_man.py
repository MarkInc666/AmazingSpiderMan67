...
"""
Mole Man Mode idea: Monster Island chapter.
Underground/drop-bank threat. Placeholder: common shots build progress; later gameplay should focus on completing/resetting drop banks and saucer escapes.
