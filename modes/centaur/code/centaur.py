...
"""
Centaur Mode idea: Monster Island chapter.
Centaur controls the spinner/lane speed. Placeholder: common shots build charge; later gameplay should focus on spinner acceleration and upper/lower transitions.
