...
class TheWebTightens(Mode):
    ...
    def _start_fiddler(self):
        ...
        self.machine.events.post("the_web_tightens_fiddler_base")
        self.machine.events.post(
            "show_mode_message_long",
    ...
    def _metal_start_attack(self):
        ...
        # Phase progress is useful context, but the newly started attack
        # countdown must be the final status event so the large timer remains.
        self._update_status()
        self.machine.events.post(
            "show_mode_countdown",
