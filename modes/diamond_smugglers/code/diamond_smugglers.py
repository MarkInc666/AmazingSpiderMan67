...
"""
DiamondSmugglers placeholder villain mode.

Mode idea:
DiamondSmugglers plays rhythm; hit shots in beat/order to build and collect sonic jackpot.
...
class DiamondSmugglers(Mode):
    MODE_KEY = "diamond_smugglers"
    DISPLAY_NAME = "DiamondSmugglers"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
