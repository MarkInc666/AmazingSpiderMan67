...
"""
Night of the Robots placeholder mini-wizard.

Mode idea:
Disable robot systems while historical robots create timed hazards.
"""


class NightOfTheRobots(Mode):
    MODE_KEY = "night_of_the_robots"
