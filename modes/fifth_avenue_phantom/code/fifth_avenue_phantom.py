...
"""
Fifth Avenue Phantom Mode idea: Crime Wave chapter.
Hidden/phantom crime scene. Placeholder: common shots build progress; later gameplay should hide the correct shot or make it appear briefly.
