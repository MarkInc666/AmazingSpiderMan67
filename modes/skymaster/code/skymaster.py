...
class Skymaster(CaseFileMixin, Mode):
    ...
    TARGETS = {
        "left": {
            ...
            "needed": "skymaster_target_left_needed",
            "solid": "skymaster_target_left_solid",
            "off": "skymaster_target_left_off",
        },
        "center": {
            "switch": "s_upper_target_center_active",
            "needed": "skymaster_target_center_needed",
            "solid": "skymaster_target_center_solid",
            "off": "skymaster_target_center_off",
        },
        "right": {
            "switch": "s_upper_target_right_active",
            "needed": "skymaster_target_right_needed",
            "solid": "skymaster_target_right_solid",
            "off": "skymaster_target_right_off",
        },
    }
    ...
    def mode_start(self, **kwargs):
        ...
        self.publish_case_file_bonus_events("skymaster")
        ...
        self.machine.events.post("skymaster_all_lights_off")
        self.machine.events.post("skymaster_saucers_needed")
    ...
    def mode_stop(self, **kwargs):
        ...
        self.delay.remove("skymaster_reenable_upper_flippers")
        self.delay.remove("skymaster_reset_for_next_attempt")
        self.machine.events.post("cmd_upper_flippers_enable")
        self.machine.events.post("skymaster_all_lights_off")
        self.machine.events.post("skymaster_stop_all_shows")
        self.machine.events.post("rooftop_diverter_close")
    ...
    def _saucer_hit(self, **kwargs):
        ...
        self.gate_open = True
        self._update_mode_status()
        self.machine.events.post("skymaster_saucers_off")
    ...
    def _upper_entrance(self, **kwargs):
        ...
        self.machine.events.post("rooftop_diverter_close")
        self.machine.events.post("skymaster_saucers_off")
        self.machine.events.post("skymaster_roof_attempt_started", flips=self.flips_remaining)
        self._light_targets_for_attempt()
        self._show_message("BLIMP ASSAULT", f"{self.flips_remaining} FLIPS")
    ...
    def _upper_flipper_pressed(self, **kwargs):
        ...
        self._update_mode_status()
        self.machine.events.post("skymaster_flips_changed", flips=self.flips_remaining)
    ...
    def _collect_unique_target(self, target, assisted=False):
        ...
        self.machine.events.post("skymaster_jackpot_collected", target=target, number=target_number, value=points)
    ...
    def _complete_roof_attempt(self):
        ...
        self.machine.events.post("skymaster_roof_attempt_complete", count=self.rooftop_jackpots)
        ...
        self.delay.add(name="skymaster_reset_for_next_attempt", ms=750, callback=self._reset_for_next_attempt)
    ...
    def _fail_roof_attempt(self):
        ...
        self.roof_attempt_active = False
        self.machine.events.post("skymaster_roof_attempt_failed")
        self.machine.events.post("cmd_upper_flippers_disable")
        self._show_message("OUT OF FLIPS", "UPPER FLIPPER DISABLED", seconds="4")
        self.delay.add(name="skymaster_reenable_upper_flippers", ms=self.FLIP_DISABLE_MS, callback=self._reenable_after_failed_attempt)
    ...
    def _reset_for_next_attempt(self):
        ...
        self.targets_hit = set()
        self.machine.events.post("rooftop_diverter_close")
        self.machine.events.post("skymaster_targets_off")
        self.machine.events.post("skymaster_saucers_needed")
        self._show_message("SAUCERS OPEN GATE", "HIT ANY SAUCER", reminder=True)
    ...
    def _vuk_hit(self, **kwargs):
        self.delay.add(name="skymaster_vuk_kick", ms=1500, callback=lambda: self.machine.events.post("up_kick"))
    ...
    def _complete_mode(self):
        ...
        self.machine.events.post("skymaster_targets_off")
        self.machine.events.post("skymaster_saucers_off")
        self._show_message("SKYMASTER", "MODE COMPLETE", value=self.mode_points, event="show_mode_jackpot")
