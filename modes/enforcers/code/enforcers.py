...
"""
Enforcers Mode idea: Crime Wave chapter.
Street-level crew attacks multiple areas. Placeholder: common shots build progress; later gameplay should split targets between left/right sides.
