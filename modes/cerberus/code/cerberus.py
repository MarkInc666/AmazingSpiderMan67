...
"""
Cerberus Mode idea: Monster Island chapter.
Three-headed monster mapped to the three saucers. Placeholder: common shots build progress; later gameplay should require lighting/collecting all three saucer heads.
