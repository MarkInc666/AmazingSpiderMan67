...
"""
Replacement Needed placeholder villain mode.

Mode idea:
Robot pirate steals jackpot value; hit lit plunder shots to take it back.
...
class SavageReplacement(Mode):
    MODE_KEY = "savage_replacement"
    DISPLAY_NAME = "Replacement Needed"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
