...
"""
Blackwell Mode idea: Crime Wave chapter.
Crime Wave setup villain. Placeholder: common shots build progress; later gameplay should combine spinner escape routes and saucer evidence.
