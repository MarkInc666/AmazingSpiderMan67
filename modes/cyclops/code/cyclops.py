...
"""
Cyclops Mode idea: Monster Island chapter.
One-eye moving shot. Placeholder: common shots build progress; later gameplay should feature one roaming lit shot that moves after hits/misses.
