...
"""
Desperado placeholder villain mode.

Mode idea:
Hypnotic cowboy robber escapes on a flying mechanical horse; full rules pending.
...
class Desperado(Mode):
    MODE_KEY = "desperado"
    DISPLAY_NAME = "Desperado"
    HIT_SCORE = 25_000
    MAJOR_SCORE = 75_000
    HITS_TO_COMPLETE = 10
